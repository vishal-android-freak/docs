...
description: "React Native app for iOS and Android with chat, projects, sessions, and terminal access"
---

## What is the CCC Mobile App?

The CCC mobile app is a native iOS and Android application that provides a full-featured mobile interface for controlling Claude Code. Built with React Native and Expo, it delivers a responsive, real-time experience for coding on the go.
...
<CardGroup cols={2}>
  <Card title="iOS 13+" icon="apple">
    Available on App Store. Supports iPhone and iPad with native SwiftUI integration.
  </Card>
  <Card title="Android 6+" icon="android">
    Available on Google Play. Supports phones and tablets with Material Design components.
  </Card>
</CardGroup>
...
<Tip>
The app uses **Expo's New Architecture** for better performance and reduced memory usage compared to previous React Native versions.
</Tip>
